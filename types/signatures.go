...
type (
	...
	// UnlockCondition is similar to UnlockConditions but it represents the
	// common address used by the wallet. The address with a single
	// publickey. All of its fields are value types which means it doesn't
	// require multiple memory allocations.
...
// UnlockCondition attempts to convert an UnlockConditions object to an
